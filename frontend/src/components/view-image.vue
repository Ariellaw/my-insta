  ...
  <transition name="modal" v-if="imageOwner && viewedImage">
    <div class="modal-mask">
      <div class="modal-wrapper">
        ...
        <div
          class="modal-container pop-up-image"
          :class="{ displayVertical: displayVertically }"
        >
          <div
            class="currImage"
            :style="{ backgroundImage: 'url(' + viewedImage.image + ')' }"
          >
          ...
          <div class="user-info-container bold-reg">
            <div class="user-info">
              ...
              />
              <span class="btn">
                <span @click="goToImageOwnerProfile"
                  >{{ imageOwner.userName }} &nbsp;&nbsp;</span
                >
                <span
                ...
                <span
                  ...
                  >Follow</span
                >
                <p @click="goToLocationImages" class="image-location">
                  {{ viewedImage.location }}
                </p>
              </span>
            </div>
          </div>
          ...
          <div class="comments" v-if="viewedImage.comments">
            ...
            ></user-comment>
            <div class="userTyping" v-if="typingUser">
          ...
          <div class="likes-and-followers">
            <div class="icons">
              ...
              <i
                v-else-if="loggedInUser"
                @click="addToUserFavorites"
                class="far fa-bookmark btn"
              ></i>
              <i
              ...
              <i
                @click="addUserLike"
                v-else-if="loggedInUser"
                class="far fa-heart btn"
              ></i>
            </div>
            <span class="column" v-if="followeesThatLiked && viewedImage.likes">
              <span
                class="namesOfLikes"
                v-if="followeesThatLiked.length === 1 && loggedInUser"
              >
                <i class="far fa-thumbs-up"></i>
                {{ followeesThatLiked[0] }}
                <span v-if="viewedImage.likes.length > 1"
                  >and {{ viewedImage.likes.length - 1 }} others</span
                >
                like this
              </span>
              <span
                class="namesOfLikes"
                v-else-if="followeesThatLiked.length === 2 && loggedInUser"
              >
                <i class="far fa-thumbs-up"></i>
                {{ followeesThatLiked[0] + ' and ' + followeesThatLiked[1] }}
                <span v-if="viewedImage.likes.length > 2"
          ...
          <div class="add-a-comment">
            <textarea
              ...
              @keydown.enter="
                addUserComment(newComment, viewedImage._id, loggedInUser._id)
              "
              v-model="newComment"
            ></textarea>
          </div>
